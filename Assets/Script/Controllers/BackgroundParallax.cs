...
public class BackgroundParallax : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        _xAxisOffset = gameObject.transform.position.x - cam.position.x;
	}
	...
	void Update ()
	{
        ...
        gameObject.transform.position = new Vector3(cameraPos.x + _xAxisOffset,gameObject.transform.position.y,gameObject.transform.position.z);
	}
}
